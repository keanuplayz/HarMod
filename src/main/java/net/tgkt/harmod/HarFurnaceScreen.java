...
public class HarFurnaceScreen extends AbstractFurnaceScreen<HarFurnaceScreenHandler> {
    private static final Identifier BACKGROUND = new Identifier("textures/gui/container/furnace.png");

    public HarFurnaceScreen(HarFurnaceScreenHandler handler, PlayerInventory inventory, Text title) {
